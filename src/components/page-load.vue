...
<template>
  <div class="loadBox">
    <main class="loader-container">
      ...
      <span class="loader-text">L o a d i n g</span>
...
.loadBox {
  ...
  color: #ffffff;
  background: #ffffff radial-gradient(circle at center, #f0f0f0 0%, #ffffff 80%)
    no-repeat;
  position: fixed;
  top: 0;
  left: 0;
...
.loader-container .loader-state + .loader-text {
  ...
  animation: loader-text-blink 0.6s ease-in-out infinite alternate;
  color: #2b2b2b;
}
